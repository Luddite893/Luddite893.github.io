...
export const legendR = (folio) => sheet('recto', `
  ...
  <div class="lg-sec"><h3>図版</h3>
    <p class="lg-note">図版はすべて銅版画調の線画とし、分類色を一色だけ重ねた二色刷りとする。
      主図版は情景、小カットは装備・拠点・象徴物、人物図版は胸像である。</p>
    <p class="lg-note">人物図版は、顔を描く。ただし<b>それは記録ではない。</b>
      記録が伝えるのは種族・被り物・髪・装い、そして役までであって、
      顔の造作も年頃も、どの記録にも書かれていない。
      眉の骨の張り、鼻梁の高さ、目の据わり、頬の落ち——
      本書に刷られているそれらは、<b>画工が記録の伝える範囲から構成したもの</b>である。
      本書はこれを似姿として主張しない。</p>
    <p class="lg-note">それでも顔を描くのは、顔の無い胸像が<b>人ではなく類型として読まれる</b>ためである。
      初版は顔を伏せた。結果として、四十九人の内円も、九人の首長も、
      同じ「ノルドの男」に見えた。役だけが違って、人が同じに見えるなら、
      それは人物図版として働いていない。
      顔を与えることで生じる誤り——読者がそれを似姿と受け取ること——は、
      この一段を刷ることで防ぐ。顔を伏せることで生じる誤りは、防ぎようがなかった。</p></div>
